/*
In this project I implemented a word search engine using C++. 
The search engine will help users to count number of occurrence of a word among given set of text files.

I was Inspired to do this Project as a way trying to replicate the finder function that is used in Microsoft suite and search engines.
*/
